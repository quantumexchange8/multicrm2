...
const variantClasses = (variant) => ({
    ...
    'bg-white text-gray-500 hover:bg-gray-100 focus:ring-purple-500 dark:text-white dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200':
        variant == 'secondary',
