...
return [
    ...
    "Confirm Read" => "I confirm that I\'ve read the",
    "Terms and Conditions" => 'Terms and Conditions',
    'Privacy Policy' => 'Privacy Policy',
    'Risk Disclosure Document' => 'Risk Disclosure Document',
    'Register Acknowledgement 1' => "I hereby acknowledge and consent that company shall provide me with the information only through a durable medium, (i.e., any instrument which enables a client to store information for future reference and adequate period, and allows the unchanged reproduction of the information stored.",
    "Register Acknowledgement 2" => "You agree that company may collect, use and disclose your personal data which you have provided in this form,for providing marketing material that you have agreed to receive, in accordance with Privacy Policy.",
    "Register Acknowledgement" => 'I acknowledge that I have read, and do hereby accept the terms and conditions stated as above.',
    "Finish" => 'Finish',
    "Continue" => 'Continue',
    ...
    "sidebar" => [
        ...
        "IB Network Tree" => "IB Network Tree",
        "AM Followers Tree" => "AM Followers Tree",
        "Rebate Allocation" => "Rebate Allocation",
